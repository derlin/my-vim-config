...
" Lucy 
" changed the statusline bg from 247 to 251 (StatusLine ctermbg)
" changed the background color (darker) via %s/=235/=235/g
...
highlight IncSearch       guifg=#2e2d2b    guibg=#ff5fd7    gui=none
highlight LineNr          guifg=#808080    guibg=#242322    gui=none
highlight StatusLine      guifg=#2e2d2b    guibg=#9e9e9e    gui=none
...
highlight WildMenu        guifg=#2e2d2b    guibg=#75d7d8    gui=none
...
highlight DiffText        guifg=#2e2d2b    guibg=#75d7d8    gui=none
...
highlight PmenuSel        guifg=#2e2d2b    guibg=#7eaefd    gui=none
...
highlight TablineSel      guifg=#2e2d2b    guibg=#9e9e9e    gui=none
...
highlight Cursor          guifg=#2e2d2b    guibg=#e2e2e2    gui=none
highlight lCursor         guifg=#2e2d2b    guibg=#e2e2e2    gui=none
...
if g:kolor_bold==0
  ...
  if g:kolor_alternative_matchparen==0
    ...
    highlight MatchParen      guifg=#ffffff    guibg=#9e9e9e    gui=bold
  endif
endif
if g:kolor_italic==0
...
if &t_Co > 255
  ...
  highlight StatusLine      ctermfg=0       ctermbg=251     cterm=none "changed bg from 247 to ..
